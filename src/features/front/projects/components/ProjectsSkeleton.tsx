	...
	return (
		<li className="mb-12">
			<div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
				...
				<Skeleton className="col-span-2 h-32 w-32" />
				<div className="z-10 sm:order-2 sm:col-span-6">
					<h3>
						<div className="group/link inline-flex items-baseline text-base font-medium leading-tight text-slate-200 hover:text-sky-400 focus-visible:text-sky-400">
	...
	return (
		<>
			...
			<div>
				...
				<div>
					<div className="group inline-flex items-baseline text-base font-medium leading-tight text-slate-200 hover:text-sky-400 focus-visible:text-sky-400">
