...
const ExperienceSection = () => {
  return (
    <div className="grid items-center justify-center gap-20 pt-6 md:grid-cols-2">
      <div className="space-y-6 border-l-2 border-dashed border-l-sky-950">
        <div className="relative w-full">
          ...
          <div className="ml-6">
            ...
            <p className="mt-2 max-w-screen-sm text-sm text-white">
              Last year I started to work as a freelancer. I have worked with
              small businesses and solo entrepreneurs, building a variety of
              things like landing pages and web scrappers.
            </p>
        ...
        <div className="relative w-full">
          ...
          <div className="ml-6">
            ...
            <p className="mt-2 max-w-screen-sm text-sm text-white">
              This was my first approach to QA roles. It was for an IA company
              based in San Francisco. I was performing manual QA on web
              scrappers.
            </p>
            <span className="mt-1 block text-sm font-semibold text-sky-500">
        ...
        <div className="relative w-full">
          ...
          <div className="ml-6">
            ...
            <p className="mt-2 max-w-screen-sm text-sm text-white">
              The company was called Snappler, it was my first job in tech. They
              taught me the basics of web development using Ruby On Rails.
            </p>
            <span className="mt-1 block text-sm font-semibold text-sky-500">
              2016 - 2018
            </span>
      ...
      <div className="flex h-full flex-col justify-center gap-6 rounded-lg bg-[#00a8e60d]/[.05] px-4">
        <h1 className="text-white-400 mb-4 text-6xl font-bold">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-relaxed">
            ...
            <span className="text-sky-500">
              I&apos;ve selected what I believe were the most relevant positions
            </span>{" "}
          ...
          <p className="leading-relaxed">
            ...
            If you want to learn more about my journey I wrote a blog post about
            it.{" "}
          </p>
