  ...
  return (
    <div className="flex gap-2 mt-10 md:w-1/2 md:mx-auto">
      ...
      <button
        ...
        data-te-ripple-init=""
        data-te-ripple-color="light"
        className="m-auto w-1/2 rounded bg-[#0077b5] py-2.5 text-white shadow-md transition-all duration-300 before:inset-0 before:border-0 before:border-white before:duration-100 before:ease-linear hover:bg-white hover:text-[#0077b5] hover:shadow-[#0077b5] hover:before:border-[25px]"
      >
