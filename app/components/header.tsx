  ...
  return (
    <header className="sticky top-0 z-10 px-4 backdrop-blur-sm">
      <nav className="w-full border-gray-200">
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between py-4 md:relative">
          <Link
            to="HeroSection"
            smooth={true}
            offset={-80}
            className="z-10 flex cursor-pointer items-center hover:text-sky-700"
          >
            {/* <Image
          src={logo}
          sizes="any"
        ...
        /> */}
          ...
          <div
            className="hidden md:absolute md:w-full w-auto items-center justify-between md:flex"
            id="navbar-cta"
          >
            <ul className="flex flex-col bg-transparent font-medium md:m-auto md:flex-row md:space-x-8">
